...
Las printaremos todas separandolas por "---" entre ellas en un solo print. 
Y finalizando la frase con "------]]]"
...
Comprobaremos de forma separada cada uno de ellos, indicandole al usuario si son o n
o correctos. Finalmente, si ambos son correctos, guardaremos en una variable boolean 
