...
2 = W
etc..."""
Datos = nombre = input('introduce el nombre: ')
Datos = numero = input('introduce el DNI: ')
print(Datos)
...
while 'opcion' == '3':
    if 'opcion' == '1':
        numero: input('introduce el primer numero: ')
if 'opcion' == '2':
    numero: input('introduce el segundo numero: ')
if numero in numero:
    del numero[numero]
else:
    print(numero[numero])
...
--------------------------------------------------------------------------------------------------- """
juego = [["1, opcionA"], ["2, opcionB"], ["3, opcionC"], ["4, opcionD"], ["5, salir"]]
for i in range(len(juego)):
    for i in range(len(juego[i])):
        print(juego[i], end=".")
        numero = input("Introduce el  numero: ")
        letra = input(" Introduce la letra: ")
        elemento4 = [numero, letra]
        juego.append(elemento4)
        print("numero <--> letras")
    print(numero, letra, sep='<-->')
    print()
